      ...
      <form @submit.prevent="submit">
        ...
        <div class="modal-card" style="width: auto">
          ...
          <section class="modal-card-body">
            ...
            <div class="columns">
              <div class="column">
                <b-field label="Tipo Aporte">
                  <b-select placeholder="Tipo Aporte" v-model="inputTipoAporte">
...
export default {
  ...
  data() {
    return {
      ...
      uri: process.env.VUE_APP_API+"aporte",
      //tablas Datos
      tablaDatos: [],
  ...
  methods: {
    ...
    submit() {
      if (this.isAdd) {
        fetch(process.env.VUE_APP_API+"Aporte", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
          body: JSON.stringify({
            ...
            tipoAporte:this.inputTipoAporte,
        ...
        fetch(
          process.env.VUE_APP_API+"Aportes",
          {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
    ...
    editFunction(row) {
      ...
      this.inputTipoAporte=row.tipoAporte
